...
| 1:05-1:15 | Alert card slides in: "Contradicts §3.1," literal clause quote, "Rep said" line | "Two seconds later, ClauseCatcher flags it, citing the exact section." | Let the card fully settle before talking over it. |
...
| 2:12-2:28 | Report screen: score ring counts up, contradiction timeline, facts row (cost, calls, errors, transcript count) | "At the end of the call, a report: what was said, what was caught, and what it cost to run, about twelve cents for this whole call." | Let the ring animation finish before cutting. |
